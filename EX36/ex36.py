...
def stairs():
    print "There's a knife lying on the stairs."
...
def box():
    ...
    print "What are you using for your defense?"
    wolf_defeted = False

    defense = raw_input("> ")

    while True:
        if defense == "knife" and not wolf_defeted:
...
def start():
    ...
    print "Where are you going? Right, left or upstairs?"
