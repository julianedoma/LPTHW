...
""", "Phhu that is a though situation! You could tell a joke to distract the Gothon? Or try to dodge. Shooting the evil creature might be doable, too.")
...
""", "A little hint that is written in one of Nietzsche's Notebook: 49 + 9 * 6 + 3 * 7 + 8")
...
""", "You can make use their hesitation and throw the bomb! Or can you think of something else?")
...
generic_death = Scene("Death...", "death", "You died. The space did not became you very well. Visit a Space Camp and come back again.", None)
